...
HEADLESS="g01-headless-liveness g03-trampoline-self-reap g04-bracketed-populate g05-rename-durability g06-submit-refusal g07-read-cap g09-materialise-roundtrip g15-join-keys g16-resume-picker g17-workspace-verbs g08-event-loop g14-fork-roundtrip g19-targeting"
fails=0
